...
// Component để hiển thị danh sách chiến dịch mà người dùng có thể rút tiền
const WithDraw = () => {
  ...
  const { address, contract, getUserCampaigns, getStatus, searchQuery, createEvent, donateEvent, refundEvent, withdrawEvent } = useStateContext(); // Lấy dữ liệu từ context
  ...
  return (
    <DisplayCampaigns  // Hiển thị danh sách chiến dịch mà người dùng có thể rút tiền
      title="All Campaigns"
      isLoading={isLoading}
